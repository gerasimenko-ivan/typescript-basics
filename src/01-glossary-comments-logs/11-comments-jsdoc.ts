 ...
 *
 * This is a DocBlock comment, and IDE will use it as a comment for an identifier below it
 * In this example it is ageOfUser
 * So if you hover ageOfUser in an IDE, you will see this DocBlock comment
 */
let ageOfUser = 33;
